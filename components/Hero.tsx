...
export default function Hero() {
    return (
        <>
            <div className="bg-hero w-full padding-x">
                <section className="bg-hero-mobile bg-cover sm:bg-hero-tablet lg:bg-hero-desktop sm:bg-cover lg:bg-left-top bg-no-repeat  lg:bg-contain  py-[6.75rem] sm:py-[7.88rem]  lg:pt-24 lg:pb-[9.88rem] wrapper max-lg:text-center text-white uppercase">
