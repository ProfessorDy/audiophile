...
export default function Hero() {
    return (
        <>
            <div className="bg-hero w-full padding-x py-[6.75rem] sm:py-[7.88rem]  lg:pt-24 lg:pb-[9.88rem] ">
                <section className="bg-hero-mobile bg-cover sm:bg-hero-tablet lg:bg-hero-desktop sm:bg-cover lg:bg-left-top bg-no-repeat  lg:bg-contain   wrapper max-lg:text-center text-white uppercase">
                    ...
                    <Link href='./headphones/xx99-mark-two' className="primary-btn mx-auto lg:mx-0 mt-7 sm:mt-10 ">see product</Link>
                </section>
            </div>
