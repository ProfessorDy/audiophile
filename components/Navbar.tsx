        ...
        <header className='sticky top-0 bg-dark padding-x pt-8 lg:pt-9 text-white uppercase'>
            ...
            <div className="wrapper">
                <div className="flex max-sm:justify-between items-center">
                    ...
                    {/* Mobile  Navigation */}
                    <nav aria-hidden={menuState ? 'false' : 'true'}>
                        <motion.ul animate={{ x: menuState ? 1025 : 0 }} className={`fixed left-[-1025px] top-[90px] bg-white z-10 h-screen px-6 pt-[84px] pb-[35px] w-full lg:hidden space-y-[68px]`} >
                    ...
                    {/* Desktop Navigation */}
                    <nav className='max-lg:hidden flex ml-auto' aria-aria-label='main'>
                    ...
                    <button className='ml-auto hover:animate-bounce'>
